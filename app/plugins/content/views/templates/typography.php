...
<?php $this->tplDisplay("inc_header.php", ['menu'=>'home']); ?>
  ...
  <div class="row">
    <div class="page-title">
      <h1>H1 Page Title</h1>
      <p class="subtitle">Sub title we are the monkees...</p>
    </div>
  </div>
  ...
  <div class="row">
    <div class="single-column content-block">
      ...
      <div class="row">
        <div class="half">
          <img src="http://www.fillmurray.com/g/750/750" alt="">
        </div>

        <div class="half">
          <blockquote>&ldquo;I go home and stay there. I wash and scrub up each day, and that's it. One month I actually grew a moustache, just so I could say that I'd done something.&rdquo;<cite>- Bill Murray</cite></blockquote>
        </div>
      </div>
  ...
  <div class="row">
    <div class="full">
      ...
      <span class="attribution">- Clive Thompson</span></blockquote>
    </div>
  </div>
