    ...
    $content = array(
      'websitemaintenance' => array(
        ...
        'chart' => array(
          ...
          'plan_breakdown' => array(
            ...
            'technical_site_updates' => array('name' => 'Technical Site Updates', 'description' => 'Quickly fix technical errors and make additional changes by request.', 'type' => 'string'),
            ...
            'seo_content_checks' => array('name' => 'SEO Content Checks', 'description' => 'Tests your site’s page load speed, a factor in Google’s search algorithm.', 'type' => 'boolean'),
            ...
            'seo_issues_report' => array('name' => 'SEO Issues Report', 'description' => 'A custom report listing any SEO issues we find on your site.', 'type' => 'boolean'),
            'seo_competition_report' => array('name' => 'SEO Competition Report', 'description' => 'See how your performance in search measures up to the competition.', 'type' => 'boolean'),
            'seo_ranking_report' => array('name' => 'SEO Ranking Report', 'description' => 'Know where your website ranks for your most valuable keywords.', 'type' => 'boolean')
          ),
          'plans' => array(
            array(
              'title' => 'Basic',
      ...
      'analytics' => array(
        ...
        'service_features' => array(
          ...
          'features' => '<li>Google Webmaster Tools</li><li>Custom Ongoing Reporting</li><li>A/B Testing</li><li>Custom Rules and Filters</li><li>Custom Segmentation</li><li>Ecommerce Tracking</li><li>Conversion Funnel Analysis</li><li>Custom Dashboards</li>',
        ),
        'being_a_client' => '<p>We don\'t really like the word client. It implies a relationship where you, the client, don\'t get to participate. That\'s not how Monkee-Boy works. This won\'t be one of those sit-back-and-enjoy-the-ride experiences. A typical Monkee-Boy project is full of epiphanies, exclamations, and visions as we collaboratively explore how you can solve the web.</p><p>In short, when you decide to work with Monkee-Boy you become <a href="/the-work/client-list/">our partner</a>. We\'ll work on your project as a team. We may even eat lunch together.</p>',
        'clients' => array(),
        'our_team' => '<p>Monkee-Boy hires thinkers and problem solvers who also happen to be excellent designers, developers, marketers and strategists. Like zombies, we pick people for their brains.</p><p>The reason is simple. We just think our clients deserve the best: a team of ridiculously smart, web-savvy people ready to solve your problems.</p>',
