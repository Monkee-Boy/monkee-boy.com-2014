<?php $this->tplDisplay("inc_header.php", ['menu'=>'news','sPageTitle'=>"News &raquo; Categories"]); ?>
					...
					<tbody>
						<?php foreach($aCategories as $aCategory): ?>
							<tr>
								...
								<?php if($sSort == "manual"): ?>
									<td class="small center">
										...
										<?php if($aCategory['sort_order'] != $minSort): ?>
											<a href="/admin/news/categories/sort/<?= $aCategory['id'] ?>/up/" title="Move Up One"><img src="/images/icons/bullet_arrow_up.png" style="width:16px;height:16px;"></a>
										<?php else: ?>
										...
										<?php if($aCategory['sort_order'] != $maxSort && count($aCategories) > 1): ?>
											<a href="/admin/news/categories/sort/<?= $aCategory['id'] ?>/down/" title="Move Down One"><img src="/images/icons/bullet_arrow_down.png" style="width:16px;height:16px;"></a>
										<?php else: ?>
											<img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D" style="width:16px;height:16px;">
										<?php endif; ?>
									</td>
								<?php endif; ?>
								<td class="center">
									<a href="/admin/news/categories/?category=<?= $aCategory['id'] ?>" title="Edit Category"><i class="icon-pencil"></i></a>
			...
			<div class="span4 aside">
					...
					<div class="accordion-group">
						...
						<div class="accordion-body in collapse">
							<div class="accordion-inner">
								<form id="edit-form" method="post" action="/admin/news/categories/edit/s/">
				...
				<?php else: ?>
					<div class="accordion-group">
						...
						<div class="accordion-body in collapse">
							<div class="accordion-inner">
								<form id="add-form" method="post" action="/admin/news/categories/add/s/">
									<div class="control-group">
										<label class="control-label" for="form-name">Name</label>
										<div class="controls">
