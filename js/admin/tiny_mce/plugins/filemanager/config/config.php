...
$upload_dir = '/uploads/editor/images/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../../uploads/editor/images/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../../uploads/editor/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
